...
if __name__ == "__main__":
    ...
    #打印图
    show_graph.showGraphInCode(heatWaterSubGraph,"./pic/烧热水子图.jpg")
    show_graph.showGraphInCode(addSugurSubGraph,"./pic/加糖子图.jpg")
    show_graph.showGraphInCode(graph,"./pic/总图.jpg")
